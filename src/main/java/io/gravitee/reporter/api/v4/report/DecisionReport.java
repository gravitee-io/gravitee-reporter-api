 ...
 *
 * <p><strong>What a producer must set.</strong> The four gateway dimensions
...
public class DecisionReport extends AbstractReportable implements WithAdditional<DecisionReport> {
    ...
    public record MatchedRule(String id, String name, String version, String effect, Map<String, String> annotations) {}
    ...
    /**
     * Required. One of {@link Phase#REQUESTED}, {@link Phase#RESOLVED}. A synchronous point emits a
    ...
    /**
     * Required. What the point <em>concluded</em>: {@link Outcome#ALLOW}, {@link Outcome#DENY},
     * {@link Outcome#TRANSFORM}, {@link Outcome#INDETERMINATE}, {@link Outcome#PENDING}. May
    ...
    /**
     * Required. What the system <em>did</em>: {@link Enforced#ALLOW}, {@link Enforced#DENY},
     * {@link Enforced#TRANSFORM}, {@link Enforced#SUSPEND}. Never unknown: a point that failed
    ...
    /**
     * Why no conclusion was reached: {@link IndeterminateCause#NOT_APPLICABLE},
     * {@link IndeterminateCause#TIMEOUT}, {@link IndeterminateCause#ERROR}, {@link IndeterminateCause#NOT_READY}.
     * Set only alongside {@link Outcome#INDETERMINATE}.
     */
    @Nullable
    ...
    /**
     * What was done: {@link TransformationType#REDACT}, {@link TransformationType#REWRITE},
     * {@link TransformationType#MASK}. Never what it was done to.
     */
    @Nullable
    ...
    /**
     * Required. Whether the evaluation itself ran: {@link Status#SUCCESS}, {@link Status#ERROR}.
