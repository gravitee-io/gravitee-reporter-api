...
public class OperationDurationEventMetricsDecorator extends OperationEventMetricsDecorator {

    private static final String DOCUMENT_TYPE = "operation_duration";
    private Long requestDurationsMillis;
    private Long responseDurationsMillis;
    private Long endpointDurationsMillis;

    public OperationDurationEventMetricsDecorator(@NonNull AbstractReportable wrapper, @NonNull String operation) {
